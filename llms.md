...
> A text that provides structured info for AI about the site/repo/... Smaller in size and focused. Compare w html version (or similar) created for humans - minimum of style.
...
## More examples:
- https://www.fastht.ml/docs/llms.txt vs https://www.fastht.ml/docs/tutorials/by_example.html

Some refs
- https://llmstxt.org/ - A proposal to standardise on using an `llms.txt` file to provide information to help LLMs use a website at inference time.